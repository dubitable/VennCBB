...
/** minimizes a export function using the downhill simplex method */
...
export function addMissingAreas(areas) {
  areas = areas.slice();
...
export function constrainedMDSGradient(x, fxprime, distances, constraints) {
  var loss = 0,
    i;
...
export function VennDiagram(width = 600, height = 350) {
  var padding = 15,
    duration = 1000,
    orientation = Math.PI / 2,
    normalize = true,
...
export function circleMargin(current, interior, exterior) {
